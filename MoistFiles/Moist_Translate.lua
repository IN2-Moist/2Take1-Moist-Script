...
LocalFeatures.Test_Global.name = "Summer 22 Crime Scenes active"
...
OnlineFeatures.BlackScreenOfDeath.feats[pid].name = "Backscreen?"
...
LocalFeatures.Test_Global.hint = "Test Global" 
