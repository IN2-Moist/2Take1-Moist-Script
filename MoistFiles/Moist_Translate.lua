...
Features.LocalParent.name = "Moist Script NG"
...
LocalFeatures.AirDefence.name = "Portable Defences Anti Player Vehicle"
LocalFeatures.AirDefence2.name = "Portable Defences Anti Player Ped"
LocalFeatures.AirDefence3.name = "Portable Defences Anti Projectile"
