...
function Moist_Translate.localmenu()
    Train_Derailed.name = "De Rail Train"
    ...
    LocalFeatures.VehHoming1.name = "Better Vehicle Lock-on Missiles: "
    LocalFeatures.VehHoming03.name = "Better Vehicle Lock-on Missiles v3: "
    LocalFeatures.VehHoming01.name = "Better Vehicle Lock-on Missiles v2: "
    ...
    LocalFeatures.StoneHatchetMode.name = "Host Queue No Cool-Down & Duration Increase"
    ...
    LocalFeatures.SaveOptions_Hotkey.name = "Options Save Hot Key"
    ...
    LocalFeatures.HeadshotAimd.name = "Aim Snipe Head-shot:"
    ...
    LocalFeatures.CHAFFCOOLDOWN.name = "Set CHAFF COOL-DOWN"
    ...
    LocalFeatures.VolicBoost.name = "Volic Boost Recharge Modifier: "
    ...
    LocalFeatures.ShoreWaveAmp.name = "Override Shore Wave Amplitude:  "
    ...
    LocalFeatures.MiniMapFull.name = "Set Mini Map Full View ON|OFF"
    ...
    LocalFeatures.BigMapMod.name = "Mini map View Mode: "
    ...
    LocalFeatures.AirDefence4.name = "Way Point Anti Player Ped"
    ...
    Features.Modules.PlayerHistory.name = "Load Player History Module"
    Features.Modules.PlayerBar.name = "Load Player Bar Module"
    ...
    Features.LocalParent.name = "Moist Script NG 3.0.1.8"
...
function Moist_Translate.onlinemenu()
    for pid = 0, 31 do
        ...
        OnlineFeatures.WeapPickup1.feats[pid].name = "Give Weapon Pickup rail-gun saves in Inventory"
        ...
        OnlineFeatures.Targetable.feats[pid].name = "Set Vehicle Target-able"
        ...
        OnlineFeats.SetMiniMap2PlayerBlip.feats[pid].name = "Mini map Zoom to Players Blip"
        OnlineFeats.SetMiniMap2Player.feats[pid].name = "Set Mini map to Players Location"
        ...
        OnlineFeats.Targetable.feats[pid].name = "Set Player Target-able"
...
function Moist_Translate.localmenu_hints()
    LocalFeatures.VehHoming1.hint = "Using your Weaponised Vehicle Missile Lock-on this will shoot Better Missiles after a delay (set by the value of this feature) 500 Delay, is not far from a legitimate looking missile fire from a distance. lower values will increase the fire rate to a point you will have rapid fire. These missile are that of the Ruiner 2000 with the circling around them tracking and rarely miss a target if they do not impact something else first. Patches the R* Nerf for MK2 Oppressor Making them OP once more & Enables less Retarded-ness Mk2 Air Combat"
    ...
    LocalFeatures.VehHoming01.hint = "Enhanced Version this will Lock-on to the driver rather than Vehicle so if they were to eject/bail from vehicle before missile gets their vehicle the Enhanced Missile will lock onto their Ped for a nice Bail Fail!\n Using your Weaponised Vehicle Missile Lock-on this will shoot Better Missiles after a delay (set by the value of this feature) 500 Delay, is not far from a legitimate looking missile fire from a distance. lower values will increase the fire rate to a point you will have rapid fire. These missile are that of the Ruiner 2000 with the circling around them tracking and rarely miss a target if they do not impact something else first. Patches the R* Nerf for MK2 Oppressor Making them OP once more & Enables less Retarded-ness Mk2 Air Combat"
    ...
    LocalFeatures.ScriptSubs.hint = "Uses Game Subtitle/Mission Help to Render Information & Notifications for some script functions. God Mode Detection will display Player Name With God Status info Below. Player History more than 700 will show text to tell you to clear it for optimal performance."
    LocalFeatures.ScriptSafe.hint = "Protects yourself against your own Script events used in Moist script Functions"
    LocalFeatures.ScriptNotifys.hint = "Use Menu Notify to display information from Script Functions. Turning This OFF will Disable Most if not all Notify's from Moist Script"
    ...
    LocalFeatures.OnFootHoming.hint = "Equip your Homing Launcher, Aim and wait for the Lock-on Square to turn Red (when using unlimited ammo clip lock-on can be a bright white) at this point shoot a missile and see another shoot along side it Destroying your Target or looping back around to hit them, Ruiner 2000 Class Missiles better Tracking of targets Improves the homing launcher to the point a MK2 Oppressor Can be taken out with ease on Foot!"
    ...
    LocalFeatures.HomingAimAmmo.hint = "Homing Functions Below this, Can be set to Different Projectile types that can lock-on to a player or vehicle. This Setting Affects all Below except the Head-shot Aim Snipe."
    ...
    LocalFeatures.GodPlayerHUD.hint = "Adds Heads Up Display Above god mode players Saying GOD & CUNT Crew Tag"
    ...
    LocalFeatures.SetTimeRate.hint = "Set Game Time in Minutes to Real-time Milliseconds"
...
function Moist_Translate.onlinemenu_hints()
    ...
    OnlineFeats.TeamChatA.feats[pid].hint = "-1 = default setting in free-mode, anything else is a team and ID gives different color for other players everyone in that team will be able to see each others team chat"
...
function Moist_Translate.Set_StrData()
    LocalFeatures.save_settings:set_str_data({"Save","Reset"})
    LocalFeatures.SessionKick:set_str_data({"Bail Kick","De-sync Kick","Host Kick","Broadcast Free mode Error"})
    LocalFeatures.Send_All_To_Beach:set_str_data({"Beach","Beach Bounty War!"})
    LocalFeatures.MissionEvents:set_str_data({"Force to Severe Weather","Force to Half Track","Force to Night Shark A.A.T","Force to APC Mission","Force to M.O.C Mission","Force to Tampa Mission","Force to Oppressor Mission1","Force to Oppressor Mission2"})
...
function Moist_Translate.Set_Online_StrData()
    for pid = 0, 31 do
        ...
        OnlineFeatures.SE_CrashV3.feats[pid]:set_str_data({"Vector Method","Stat Method","Random Method","Moist Method","Bit Method"})
        OnlineFeatures.SE_CrashV2.feats[pid]:set_str_data({"Vector Method","Stat Method","Random Method","Moist Method","Bit Method"})
        OnlineFeatures.SE_Crash.feats[pid]:set_str_data({"Vector Method","Stat Method","Random Method","Moist Method","Bit Method"})
        ...
        OnlineFeatures.MissionEvents.feats[pid]:set_str_data({"Force to Severe Weather","Force to Half Track","Force to Night Shark A.A.T","Force to APC Mission","Force to M.O.C Mission","Force to Tampa Mission","Force to Oppressor Mission1","Force to Oppressor Mission2"})
        OnlineFeatures.Island_Events.feats[pid]:set_str_data({"Send To Island v1","Send To Island v2","Kick From Island","Island Force Remove","test Method"})
