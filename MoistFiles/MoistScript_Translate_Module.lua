...
langID["ZM"] = "en"
langID["ZW"] = "sn"
trans_parent = menu.add_feature("Translate Game Chat", "parent", LocalFeatures["LocalSettings"].id)
...
local TranslateThread = menu.create_thread(Translation_Main)