...
function Moist_Translate.localmenu()
	...
	LocalFeatures.Online_Data.name = "Session Attributes"
	...
	LocalFeatures.SendAll_To_Beach.name = "Player Broadcast to Del Pero : "
	...
	LocalFeatures.Drone_RangeNoCD.name = "TB Drone(+)Range+Speed (-)cooldown+recharge"
...
function Moist_Translate.onlinemenu()
	for pid = 0, 31 do
		...
		FeaturesonlineParent.feats[pid].name = "Moist Script NG 3.0.2.1"
		...
		OnlineFeatures.WeapPickup1.feats[pid].name = "Give Weapon Pickup rail-gun"
		...
		OnlineFeats.UnlockMinimapZoom.feats[pid].name = "Unlock Mini map Zoom"
		...
		OnlineFeatures.BlackScreenOfDeath.feats[pid].name = "Back-screen?"
...
function Moist_Translate.localmenu_hints()
	...
	LocalFeatures.DoomsDayA2.hint = "turn on before starting the finale leave all pay-outs as they are set and just launch the job all will get 2.5m each"
